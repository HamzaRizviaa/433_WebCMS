...
export const selectNewsTotalRecords = (state) => state.rootReducer.newsLibrary.totalRecords;

export const selectNewsNoResultStatus = (state) => state.rootReducer.newsLibrary.noResultStatus;
